        ...
        <tbody>
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><img src="<?php echo htmlspecialchars($row['productImg'] ?: 'img/placeholder.jpg'); ?>" alt="<?php echo htmlspecialchars($row['productName']); ?>" class="cart-item-img" width="70" height="70"></td>
