...
if (isset($_POST['id_token'])) {
    ...
    $client = new Google_Client(['client_id' => '139900539257-dojbov6kpd0s8rv58g83n7as14dt681v.apps.googleusercontent.com']); // Specify the CLIENT_ID of the app that accesses the backend
