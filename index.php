...
$sql = "SELECT * FROM PRODUCTS ORDER BY createdAt DESC LIMIT 8"; // Show 8 latest products
...
<body>
    ...
    <section id="menu-preview" class="menu-preview">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="menu-card fade-in">
                        <a href="product_detail.php?id=<?php echo $row['productId']; ?>" class="product-link">
        ...
        <div class="full-menu-btn-container">
            <a href="products.php" class="full-menu-btn">View Full Menu</a>
        </div>
    </section>
        ...
        <div class="reviews-scroller">
            <div class="reviews-track">
                ...
                <div class="review-box">
                    ...
                    <p>Bought a cake for my wife’s birthday and she said it was the best ever.</p>
                </div>
                <div class="review-box">
